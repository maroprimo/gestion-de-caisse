...
Application pour gestion d'entreprise
                                ...
                                <div class="checkbox-fade fade-in-primary d-block">
                                    <label class="check-task d-block">
                                        ...
                                        <span><h6>Meeting With HOD's and borad</h6>
                                            ...
                                            <div class="task-card-img m-l-40">
                                                <a href="#!"><img src="{{ asset('images/avatar-2.jpg') }}" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40"></a>
                                                <a href="#!"><img src="{{ asset('images/avatar-3.jpg') }}" data-toggle="tooltip" title="Alia" alt="" class="img-40 m-l-10"></a>
                                                <a href="#!"><img src="{{ asset('images/avatar-2.jpg') }}" data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-10"></a>
                                            </div>
                                        </label>
                                    </div>
                                </div>
