                ...
                <div class="tab-content tabs card-block">
                  <div class="tab-pane active" id="home1" role="tabpanel">
                    <div class="card-block">
                      <form action="{{ route('admin.sauverproduit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="category">Catégorie</label>
                        <div class="col-sm-10">
                      <div class="card-block accordion-block">
                        <div id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="accordion-panel">
                                <div class="accordion-heading" role="tab" id="headingOne">
                                    <h3 class="card-title accordion-title">
                                        ...
                                        <label>Choisissez une catégorie pour le produit :</label>
                                    </a>
                                </h3>
                            </div>
                            ...
                            <div class="accordion-content accordion-desc">
                              ...
                              @include('partials.category-radio', ['category' => $category, 'prefix' => ''])
                              @endforeach
                            </div>
                        </div>
                        </div>
                            ...
                            <tbody>
                              ...
                              <tr class="table-active">
                                ...
                                <td>{{$produit->designation}}</td>
                                  ...
                                  <td>@foreach ($produit->units as $unit)
                                     {{ $unit->main_unit }} <br>
                                     {{ $unit->sub_unit }}
                                    @endforeach
                                </td>
                                ...
                                <td>{{$produit->seuil}} {{$unit->main_unit}}</td>
                                <td>
